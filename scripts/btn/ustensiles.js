...
<div class="  h-14 w-48 bg-white mb-16 cursor-pointer max-h-[324px] rounded-lg m-0">
  ...
  <h1 class="absolute top-[16px] left-[580px] text-base font-medium font-Manrope">Ustensiles</h1>
  <i class="fa-solid fa-chevron-down absolute top-[20px] left-[721px] transition-transform duration-500 rotate-0 peer-checked:rotate-180"></i>
  ...
  <div class="bg-white w-48  overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-[315px] z-10 absolute top-[47px] rounded-lg pt-[12px]">
    ...
    <ul id="list_Ustensiles" class="pt-4 max-h-60 overflow-y-auto"></ul>
  </div>
</div>
`;
...
//  */
// const valueIngredient = document.getElementById("UstensilesSearch");
